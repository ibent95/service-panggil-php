<?php
    ...
    $menuTeknisiAll = getMenuUserByUserTypeLimitAll($page, class_static_value::$record_count, "teknisi");
    $pagination = new Zebra_Pagination();
    $pagination->records(mysqli_num_rows(getMenuUserByUserTypeAll("teknisi")));
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <p>
                                <a class="btn btn-primary float-left" href="?content=data_konfigurasi_menu_teknisi_form&action=tambah">
                                    Tambah Data
                                </a>
                            </p>
                        </div>
                        ...
                        <table class="table table-hover table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>Induk (Parent)</th>
                                    <th>URL</th>
                                    <th>Konfigurasi CSS</th>
                                    <th>Aksi</th>
                                </tr>
                            </thead>
                            <tbody id="data_list">
                                <?php if (mysqli_num_rows($menuTeknisiAll) == 0) : ?>
                                    <tr>
                                        <td colspan="5">
                                            <center>
                                                Tidak ada data..!
                                ...
                                <?php endif ?>
                                <?php if (mysqli_num_rows($menuTeknisiAll) >= 1) : ?>
                                    <?php while ($data = mysqli_fetch_array($menuTeknisiAll, MYSQLI_BOTH)) : ?>
                                        <tr>
                                            <td><?php echo $data['nama']; ?></td>
                                            <td><?php echo $data['parent']; ?></td>
                                            <td><?php echo $data['url']; ?></td>
                                            <td><?php echo $data['konfigurasi_css']; ?></td>
                                            <td>
                                                <a
                                                    class="btn btn-primary btn-orange btn-sm"
                                                    href="?content=data_konfigurasi_menu_teknisi_form&action=ubah&id=<?php echo $data[0]; ?>"
                                                >
                                                    Ubah
                                                </a>
                                                <a
                                                    class="btn btn-danger btn-sm"
                                                    href="?content=data_konfigurasi_menu_teknisi_proses&proses=remove&id=<?php echo $data[0]; ?>"
