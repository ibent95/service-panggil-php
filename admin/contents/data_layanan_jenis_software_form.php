<?php
    ...
    if ($action == NULL) {
        ...
        echo "<script>location.replace('?content=data_layanan_jenis_software')</script>";
    }
    $kategoriAll = getKategoriAll();
    if ($action == 'ubah') {
        $jenis = mysqli_fetch_assoc(
            getJenisSoftwareById($id)
        );
    }
?>
<!-- Bread crumb -->
<div class="row page-titles">
    ...
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="?content=data_layanan_jenis_software">Kategori Software</a>
            </li>
            <li class="breadcrumb-item active">Tambah Data Jenis Layanan Kategori Software</li>
        </ol>
    </div>
</div>
<!-- End Bread crumb -->
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-title">
                    <h4>Form Data Jenis Layanan Kategori Software</h4>
                </div>
                <div class="card-body">
                    <form
                        class="form-horizontal"
                        <?php if ($action == 'tambah') : ?>
                            action="?content=data_layanan_jenis_software_proses&proses=add"
                        <?php else: ?>
                            action="?content=data_layanan_jenis_software_proses&proses=edit"
                        <?php endif ?>
                        method="POST"
                    >
                        <?php if ($action == 'ubah') : ?>
