<?php 
    ...
    if ($action == NULL) {
        ...
        echo "<script>location.replace('?content=data_pengguna_teknisi')</script>";
    }
    if ($action == 'ubah') {
                ...
                <div class="card-body">
                    ...
                    <form 
                        ...
                        <?php if ($action == 'tambah'): ?>
                            action="?content=data_pengguna_teknisi_proses&proses=add" 
                        <?php else: ?>
                            action="?content=data_pengguna_teknisi_proses&proses=edit"
                        <?php endif ?>
                        method="POST"
