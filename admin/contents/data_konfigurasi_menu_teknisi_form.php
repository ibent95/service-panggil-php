<?php
    ...
    if ($action == NULL) {
        ...
        echo "<script>location.replace('?content=data_konfigurasi_menu_teknisi')</script>";
    }
    if ($action == 'ubah') {
        $menuTeknisi = mysqli_fetch_assoc(
            getMenuUserByIdUserType($id, "teknisi")
        );
    }
    $menuTeknisiAll = getMenuUserByUserTypeAll("teknisi", "ASC");
?>
<!-- Bread crumb -->
<div class="row page-titles">
    ...
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="?content=data_konfigurasi_menu_pelanggan">Teknisi</a>
            </li>
            <li class="breadcrumb-item active">Tambah Data Konfigurasi Menu Teknisi</li>
        </ol>
    </div>
</div>
<!-- End Bread crumb -->
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-title">
                    <h4>Form Data Konfigurasi Menu Teknisi</h4>
                </div>
                <div class="card-body">
                    <form
                        class="form-horizontal"
                        <?php if ($action == 'tambah') : ?>
                            action="?content=data_konfigurasi_menu_teknisi_proses&proses=add"
                        <?php else : ?>
                            action="?content=data_konfigurasi_menu_teknisi_proses&proses=edit"
                        <?php endif ?>
                        method="POST"
                    >
                        <?php if ($action == 'ubah') : ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input
                                    ...
                                    id="nama_menu"
                                    <?php if ($action == 'ubah') : ?>
                                        value="<?php echo $menuTeknisi['nama']; ?>"
                                    <?php endif ?>
                                />
                            </div>
                        </div>
                           ...
                           <label for="parent" class="control-label col-md-3">Induk (Parent)</label>
                            <div class="col-md-5">
                                <select class="form-control input-focus" name="parent" id="parent">
                                    ...
                                    <?php foreach ($menuTeknisiAll as $data): ?>
                                        <option
                                            value="<?php echo $data['id_konfigurasi_menu_teknisi']; ?>"
                                            <?php if ($action == 'ubah') : ?>
                                                <?php if ($menuTeknisi['parent'] == $data['id_konfigurasi_menu_teknisi']) : ?>
                                                    selected
                                                <?php endif ?>
                                            <?php endif ?>
                                        >
                                            <?php echo "[" . $data['id_konfigurasi_menu_teknisi'] . "] " . $data['nama']; ?>
                                        </option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input
                                    ...
                                    id="url"
                                    <?php if ($action == 'ubah') : ?>
                                        value="<?php echo $menuTeknisi['url']; ?>"
                                    <?php endif ?>
                                />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input
                                    ...
                                    id="konfigurasi_css"
                                    <?php if ($action == 'ubah') : ?>
                                        value="<?php echo $menuTeknisi['konfigurasi_css']; ?>"
                                    <?php endif ?>
                                />
                            </div>
                        </div>
