<?php
    ...
    $pemesananAll = getPemesananSubJoinLimitAll($page, $_SESSION['record-count'], 'batal', '');

    $pagination = new Zebra_Pagination();
    $pagination->records(mysqli_num_rows(getPemesananSubJoinAll('batal')));
...
<div class="row page-titles">
    ...
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Batal</li>
        </ol>
    </div>
</div>
<!-- End Bread crumb -->
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-title">
                    <h4>Daftar Transaksi yang Batal</h4>
                </div>
                                ...
                                <?php else: ?>
                                    <?php while ($data = mysqli_fetch_array($pemesananAll, MYSQLI_BOTH)): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($data['status_pemesanan'] == 'tunggu'): ?>
                                                    <span class="badge badge-pill badge-primary">Tunggu</span>
                                                <?php elseif ($data['status_pemesanan'] == 'proses'): ?>
                                                    <span class="badge badge-pill badge-primary">Proses</span>
                                                <?php elseif ($data['status_pemesanan'] == 'batal'): ?>
                                                    <span class="badge badge-pill badge-danger">Batal</span>
                                                <?php elseif ($data['status_pemesanan'] == 'selesai'): ?>
                                                    <span class="badge badge-pill badge-success">Selesai</span>
                                                <?php endif ?>
                                            </td>
                                            <td><?php echo (isset($data['rating']) AND (!empty($data['rating']) OR $data['rating'] != NULL)) ? showRating($data['rating'], 20) : showRating(0, 20) ; echo " [" . $data['rating'] . "]" . "<br><a
                                                    class='btn btn-link btn-sm'
                                                    href='?content=diagnosis&action=lihat&id=$data[0]#ratingUlasan'
                                                >Lihat Rating & Ulasan</a>";?></td>
                                            <td>
                                                <!-- <a 
