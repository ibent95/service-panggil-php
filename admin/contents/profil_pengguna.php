<?php
    if (isset($_GET['proses']) && $_GET['proses'] == "ganti-password"
        ...
        $proses = $_GET['proses'];
        // $result = ;
        if (changePasswordPengguna($_POST['currentPassword'], $_POST['newPassword'], $_SESSION['id']) == TRUE) {
            echo "<script>location.replace('$csv::$URL_BASE/?content=profil_pengguna'); </script>";
        } else {
            echo "<script>location.replace('$csv::$URL_BASE/?content=beranda'); </script>";
        }
    }
    $admin = mysqli_fetch_array(
        getPenggunaById($_SESSION['id']),
        MYSQLI_BOTH
    );
?>
...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-title">
            ...
            <a class="btn btn-primary btn-sm" href="?content=profil_pengguna_form&action=ubah&id=<?php echo $admin['id_pengguna']; ?>">Sunting</a>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="center">
                <div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <label class="col-form-label" id="status_akun">
                                            : <?php echo setBadges($admin['status_akun'], 'success'); ?>
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-5">
                        <img class="img-thumbnail float-right" src="<?php echo searchFile($admin['url_foto'], 'img', 'short'); ?>" alt="" style="height: 350px;" id="image_gallery">
                    </div>
                </div>
            </div>
