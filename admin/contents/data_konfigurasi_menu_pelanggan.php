<?php
    ...
    $menuPelangganAll = getMenuUserByUserTypeLimitAll($page, 15, "pelanggan");

    $pagination = new Zebra_Pagination();
    $pagination->records(mysqli_num_rows(getMenuUserByUserTypeAll("pelanggan")));
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <p>
                                <a class="btn btn-primary float-left" href="?content=data_konfigurasi_menu_pelanggan_form&action=tambah">
                                    Tambah Data
                                </a>
                            </p>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped table-bordered">
                            ...
                            <tbody id="data_list">
                                <?php if (mysqli_num_rows($menuPelangganAll) == 0): ?>
                                    <tr>
                                        <td colspan="5">
                                            <center>
                                                Tidak ada data..!
                                ...
                                <?php endif ?>
                                <?php if (mysqli_num_rows($menuPelangganAll) >= 1): ?>
                                    <?php while ($data = mysqli_fetch_array($menuPelangganAll, MYSQLI_BOTH)): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a
                                                        ...
                                                        href="?content=data_konfigurasi_menu_pelanggan_form&action=ubah&id=<?php echo $data[0]; ?>"
                                                    >
                                                        Ubah
                                                    </a>
                                                    <a
                                                        class="btn btn-danger btn-sm"
                                                        href="?content=data_konfigurasi_menu_pelanggan_proses&proses=remove&id=<?php echo $data[0]; ?>"
