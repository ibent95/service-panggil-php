<?php
    ...
    $pemesananAll = getPemesananSubJoinLimitAll($page, $_SESSION['record-count'], 'proses', '');

    $pagination = new Zebra_Pagination();
    $pagination->records(mysqli_num_rows(getPemesananSubJoinAll('proses')));
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-title">
                    <h4>Daftar Transaksi dalam Proses</h4>
                </div>
                                    ...
                                    <?php while ($data = mysqli_fetch_array($pemesananAll, MYSQLI_BOTH)): ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                >
                                                    Rincian
                                                </button> <!-- href="?content=pemesanan_detail&id=<?php //echo $data[0]; ?>" -->
                                                <!-- <a 
