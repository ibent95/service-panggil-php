<?php 
    ...
    if ($action == NULL) {
        ...
        echo "<script>location.replace('?content=profil_pengguna')</script>";
    }
    if ($action == 'ubah') {
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form
                        ...
                        <?php if ($action == 'ubah'): ?>
                            action="?content=profil_pengguna_proses&proses=edit"
                        <?php else: ?>
                            action="?content=profil_pengguna_proses&proses=add"
                        <?php endif ?>
                        method="POST"
                    ...
                    >
                        ...
                        <div class="form-group">
                            <label for="url_file_foto" class="control-label col-md-3">
                                Foto
                            </label>
                            <div class="col-md-12">
                                <input
                        ...
                        <?php if (!empty($pengguna['url_foto'])) : ?>
                            <div class="form-group">
                                <div class="col-md-offset-3 col-md-9">
                                    <img class="img-thumbnail" width='90dp' src='<?php echo searchFile($pengguna['url_foto'], 'img', 'short'); ?>' id="image_gallery" />
                                </div>
                            </div>
                        <?php endif ?>
                        <!-- <div class="form-group">
