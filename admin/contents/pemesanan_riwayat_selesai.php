<?php
    ...
    $pemesananAll = getPemesananSubJoinLimitAll($page, class_static_value::$record_count, 'selesai', '');

    $pagination = new Zebra_Pagination();
    $pagination->records(mysqli_num_rows(getPemesananSubJoinAll('selesai')));
