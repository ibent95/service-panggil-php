                            ...
                            <div class="login-content card">
                                <div class="login-form">
                                    ...
                                    <ul class="nav nav-tabs nav-justified customtab" role="tablist">
                                        <li class="nav-item"> 
                                            <a class="nav-link active" data-toggle="tab" href="#pengguna" role="tab">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane p-20 active" id="pengguna" role="tabpanel">
                                            <form action="index.php?content=login_proses&proses=login&user=pengguna" method="POST">
