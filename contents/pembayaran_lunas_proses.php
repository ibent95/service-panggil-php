		...
		case 'add':
			if (isset($_POST['checkout'])) {
				try {
					...
					array_push($messages, array("success", "Upload bukti pembayaran berhasil, silahkan tunggu konfirmasi dari pihak Admin..!"));
					...
					array_push($messages, array("danger", "Upload bukti pembayaran tidak berhasil, silahkan coba lagi..!"));
