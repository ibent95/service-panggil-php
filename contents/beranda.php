				...
				<div class="row h-100 align-items-center">
					<div class="col-12">
						...
						<div class="hero-slides-content text-center">
							<h2>Jasa service dan maintenance komputer Makassar</h2>
							...
							<div class="welcome-btn-group">
								<a href="?content=perbaikan" class="btn alazea-btn mr-30">PESAN SEKARANG</a>
					...
					<div class="row">
						...
						<div class="col-12 col-sm-6">
							<div class="single-benefits-area">
								<img src="assets/frontend/img/core-img/b1.png" alt="">
						...
						<div class="col-12 col-sm-6">
							<div class="single-benefits-area">
								<img src="assets/frontend/img/core-img/b2.png" alt="">
						...
						<div class="col-12 col-sm-6">
							<div class="single-benefits-area">
								<img src="assets/frontend/img/core-img/b3.png" alt="">
								<h5>100% Natural</h5>
								<p>Intiam eu sagittis est, at commodo lacini libero. Praesent dignissim sed odio vel aliquam manta lagorn.</p>
							</div>
						</div>
						...
						<div class="col-12 col-sm-6">
							<div class="single-benefits-area">
								<img src="assets/frontend/img/core-img/b4.png" alt="">
	...
	<div class="container-fluid">
		...
		<div class="row alazea-portfolio">
			...
			<div class="col-12 col-sm-6 col-lg-3 single_portfolio_item design home-design wow fadeInUp" data-wow-delay="100ms">
				//Portfolio Thumbnail
				<div class="portfolio-thumbnail bg-img" style="background-image: url(assets/frontend/img/bg-img/16.jpg);"></div>
			...
			<div class="col-12 col-sm-6 col-lg-3 single_portfolio_item garden wow fadeInUp" data-wow-delay="200ms">
				//Portfolio Thumbnail
				<div class="portfolio-thumbnail bg-img" style="background-image: url(assets/frontend/img/bg-img/17.jpg);"></div>
				//Portfolio Hover Text
				<div class="portfolio-hover-overlay">
			...
			<div class="col-12 col-sm-6 col-lg-3 single_portfolio_item garden design wow fadeInUp" data-wow-delay="300ms">
				//Portfolio Thumbnail
				<div class="portfolio-thumbnail bg-img" style="background-image: url(assets/frontend/img/bg-img/18.jpg);"></div>
				//Portfolio Hover Text
				<div class="portfolio-hover-overlay">
			...
			<div class="col-12 col-sm-6 col-lg-3 single_portfolio_item garden office-design wow fadeInUp" data-wow-delay="400ms">
				//Portfolio Thumbnail
				<div class="portfolio-thumbnail bg-img" style="background-image: url(assets/frontend/img/bg-img/19.jpg);"></div>
				//Portfolio Hover Text
				<div class="portfolio-hover-overlay">
			...
			<div class="col-12 col-sm-6 col-lg-3 single_portfolio_item design office-design wow fadeInUp" data-wow-delay="100ms">
				//Portfolio Thumbnail
				<div class="portfolio-thumbnail bg-img" style="background-image: url(assets/frontend/img/bg-img/20.jpg);"></div>
				//Portfolio Hover Text
				<div class="portfolio-hover-overlay">
			...
			<div class="col-12 col-sm-6 col-lg-3 single_portfolio_item garden wow fadeInUp" data-wow-delay="200ms">
				//Portfolio Thumbnail
				<div class="portfolio-thumbnail bg-img" style="background-image: url(assets/frontend/img/bg-img/21.jpg);"></div>
				//Portfolio Hover Text
				<div class="portfolio-hover-overlay">
			...
			<div class="col-12 col-lg-6 single_portfolio_item home-design wow fadeInUp" data-wow-delay="300ms">
				//Portfolio Thumbnail
				<div class="portfolio-thumbnail bg-img" style="background-image: url(assets/frontend/img/bg-img/22.jpg);"></div>
				//Portfolio Hover Text
				<div class="portfolio-hover-overlay">
		...
		<div class="row">
			...
			<div class="col-12 col-sm-6 col-lg-3">
				<div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="100ms">
					...
					<div class="product-img">
						<a href="shop-details.html"><img src="assets/frontend/img/bg-img/9.jpg" alt=""></a>
						//Product Tag
			...
			<div class="col-12 col-sm-6 col-lg-3">
				<div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="200ms">
					//Product Image
					<div class="product-img">
						<a href="shop-details.html"><img src="assets/frontend/img/bg-img/10.jpg" alt=""></a>
						<div class="product-meta d-flex">
							<a href="#" class="wishlist-btn"><i class="icon_heart_alt"></i></a>
							<a href="cart.html" class="add-to-cart-btn">Add to cart</a>
							<a href="#" class="compare-btn"><i class="arrow_left-right_alt"></i></a>
			...
			<div class="col-12 col-sm-6 col-lg-3">
				<div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="300ms">
					//Product Image
					<div class="product-img">
						<a href="shop-details.html"><img src="assets/frontend/img/bg-img/11.jpg" alt=""></a>
						<div class="product-meta d-flex">
							<a href="#" class="wishlist-btn"><i class="icon_heart_alt"></i></a>
							<a href="cart.html" class="add-to-cart-btn">Add to cart</a>
							<a href="#" class="compare-btn"><i class="arrow_left-right_alt"></i></a>
			...
			<div class="col-12 col-sm-6 col-lg-3">
				<div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="400ms">
					//Product Image
					<div class="product-img">
						<a href="shop-details.html"><img src="assets/frontend/img/bg-img/12.jpg" alt=""></a>
						//Product Tag
	...
	<div class="container">
		...
		<div class="row justify-content-center">
			...
			<div class="col-12 col-md-6 col-lg-4">
				<div class="single-blog-post mb-100">
					<div class="post-thumbnail mb-30">
						<a href="single-post.html"><img src="assets/frontend/img/bg-img/6.jpg" alt=""></a>
					</div>
			...
			<div class="col-12 col-md-6 col-lg-4">
				<div class="single-blog-post mb-100">
					<div class="post-thumbnail mb-30">
						<a href="single-post.html"><img src="assets/frontend/img/bg-img/7.jpg" alt=""></a>
					</div>
					<div class="post-content">
						<a href="single-post.html" class="post-title">
			...
			<div class="col-12 col-md-6 col-lg-4">
				<div class="single-blog-post mb-100">
					<div class="post-thumbnail mb-30">
						<a href="single-post.html"><img src="assets/frontend/img/bg-img/8.jpg" alt=""></a>
					</div>
					<div class="post-content">
						<a href="single-post.html" class="post-title">
...
<!-- <section class="subscribe-newsletter-area" style="background-image: url(assets/frontend/img/bg-img/subscribe.png);">
	...
	<div class="subscribe-side-thumb wow fadeInUp" data-wow-delay="500ms">
		<img class="first-img" src="assets/frontend/img/core-img/leaf.png" alt="">
	</div>
</section> -->
<!-- ##### Subscribe Area End ##### -->
