...
<div 
    ...
    tabindex="-1" 
    role="dialog" 
    aria-labelledby="ubah_pengerjaan" 
    aria-hidden="true"
    id="modal_edit_pengerjaan" 
>
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ubah_pengerjaan">Form Ubah Pengerjaan</h5>
                <button 
                    class="btn-lg close" 
                    data-dismiss="modal" 
                    aria-label="Close"
            ...
            <div class="modal-body">
                <form class="form-horizontal" name="frmChange" method="POST" action="?content=pengerjaan_proses&proses=edit">
