            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input 
                                    ...
                                    id="url_file_foto"
                                    <?php if ($action == 'ubah'): ?>
                                        value="<?php echo $pengguna['url_file_foto']; ?>"
                                    <?php endif ?>
                                />
                            </div>
                        </div>
                        ...
                        <?php 
                            if (
                                !empty($pengguna['url_file_foto']) &&
                                file_exists("../assets/img/pengguna/" . $pengguna['url_file_foto'])
                            ): 
                        ?>
                            <div class="form-group">
                                <div class="col-md-offset-3 col-md-9">
                                    <img class="img-thumbnail" width='90dp' src='<?php echo searchFile("pengguna/$pengguna[url_file_foto]", "img"); ?>' id="image_gallery" />
                                </div>
                            </div>
                        <?php endif ?>
