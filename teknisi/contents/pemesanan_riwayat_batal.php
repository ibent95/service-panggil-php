<?php
    ...
    $pemesananAll = getPemesananSubJoinLimitByIdTeknisi($page, $_SESSION['record-count'], 'batal', $_SESSION['id']);

    $pagination = new Zebra_Pagination();
    $pagination->records(mysqli_num_rows(getPemesananSubJoinByIdTeknisi('batal', $_SESSION['id'])));
