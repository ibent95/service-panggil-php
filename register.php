                                ...
                                <div class="login-form">
                                    ...
                                    <ul class="nav nav-tabs nav-justified customtab" role="tablist">
                                        <li class="nav-item"> 
                                            <a class="
                                                nav-link 
                                                <?php if ($type == "pelanggan" or $type == null) : ?>
                                                    active
                                                <?php endif ?>
                                            " data-toggle="tab" href="#pelanggan" role="tab">
                                    ...
                                    <div class="tab-content">
                                        <div class="
                                            ...
                                            <?php if ($type == "pelanggan" or $type == null) : ?>
                                                active
                                            <?php endif ?>
                                        " id="pelanggan" role="tabpanel">
                                            <form action="index.php?content=login_proses&proses=register&user=pelanggan" method="POST" enctype="multipart/form-data">
                                        ...
                                        " id="teknisi" role="tabpanel">
                                            <form action="index.php?content=login_proses&proses=register&user=teknisi" method="POST" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    <label>Nama Lengkap</label>
                                                    <input type="text" class="form-control" name="nama_lengkap" placeholder="Nama Lengkap...">
                                                </div>
